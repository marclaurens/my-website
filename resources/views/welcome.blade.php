...
<body class="bg-gray-50 font-sans antialiased min-h-screen">
    ...
    <main class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl font-extrabold text-gray-900 mb-4">Welcome to Our Website</h1>
        ...
        @auth
            <div class="inline-flex space-x-4">
                <a href="{{ route('admin.pages.index') }}" class="bg-indigo-600 text-white font-medium px-5 py-2.5 rounded-lg shadow hover:bg-indigo-700">
                    Manage Pages
                </a>
        ...
        @else
            <a href="{{ route('login') }}" class="bg-indigo-600 text-white font-medium px-5 py-2.5 rounded-lg shadow hover:bg-indigo-700">
                Log In to Admin
            </a>
        @endauth
    </main>
