# ============================================================
# apply-layout-phase1.ps1
# Consolidates the two parallel layouts into one base + two thin wrappers.
# ============================================================
...
function Write-File($relativePath, $content) {
    ...
    Write-Host ("Wrote {0} ({1} bytes)" -f $relativePath, (Get-Item $full).Length)
}

# ---------- 1. resources/views/layouts/base.blade.php (NEW) ----------
Write-File "resources\views\layouts\base.blade.php" @'
<!DOCTYPE html>
...
# ---------- 2. resources/views/layouts/app.blade.php (REWRITE - thin wrapper) ----------
Write-File "resources\views\layouts\app.blade.php" @'
<x-base-layout>
    {{ $slot }}
</x-base-layout>
'@

# ---------- 3. resources/views/layouts/admin.blade.php (REWRITE - thin wrapper) ----------
Write-File "resources\views\layouts\admin.blade.php" @'
<x-base-layout>
    {{ $slot }}
</x-base-layout>
'@

# ---------- 4. app/View/Components/BaseLayout.php (NEW) ----------
Write-File "app\View\Components\BaseLayout.php" @'
<?php
...
# ---------- 5. app/View/Components/AdminLayout.php (NEW) ----------
Write-File "app\View\Components\AdminLayout.php" @'
<?php
...
Write-Host ""
Write-Host "Phase 1 complete. Now run:"
