...
<div class="container mx-auto py-6">
    ...
    <form action="<?php echo e(route('admin.posts.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="new_category" id="new_category" value="<?php echo e(old('new_category')); ?>" class="w-full border rounded p-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Leave blank to use the dropdown above">
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="body">Content</label>
            <textarea name="body" id="body"><?php echo e(old('body')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6 flex items-center space-x-6">
            <label class="inline-flex items-center">
                <input type="checkbox" name="is_published" id="is_published" value="1" <?php echo e(old('is_published') ? 'checked' : ''); ?> class="mr-2 h-4 w-4 text-blue-600 border-gray-300 rounded">
...
<?php endif; ?>
<?php /**PATH C:\Users\marcl\Desktop\my-website\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>