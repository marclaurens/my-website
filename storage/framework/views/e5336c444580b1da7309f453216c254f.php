    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="<?php echo e(route('admin.categories.store')); ?>" method="POST" class="mb-6 flex gap-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b">
                                ...
                                <td class="py-2 text-gray-500"><?php echo e($category->slug); ?></td>
...
<?php endif; ?><?php /**PATH C:\Users\marcl\Desktop\my-website\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>