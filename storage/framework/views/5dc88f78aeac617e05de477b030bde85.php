...
<div class="container mx-auto py-6">
            ...
            <div>
                ...
                <select name="parent_id" class="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <?php $__currentLoopData = $flattened; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row->item->id); ?>"><?php echo e(str_repeat('— ', $row->depth)); ?><?php echo e($row->item->title); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
    ...
    <div class="bg-white shadow rounded p-6">
        ...
        <ul class="divide-y divide-gray-200">
            <?php $__empty_1 = true; $__currentLoopData = $flattened; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php $item = $row->item; $depth = $row->depth; ?>
                <li class="py-4" style="padding-left: <?php echo e($depth * 24); ?>px;" x-data="{ editing: false }">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto justify-between md:justify-end">
                            ...
                            <form action="<?php echo e(route('admin.menu.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Remove this menu item? Any children will be promoted to the top level.');">
                                <?php echo csrf_field(); ?>
                    ...
                    <div x-show="editing" style="display: none;" class="mt-4 bg-gray-50 border rounded p-4">
                        <form action="<?php echo e(route('admin.menu.update', $item->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                <div>
                                    <label class="block text-sm font-medium mb-1">Link Title</label>
                                    <input type="text" name="title" value="<?php echo e($item->title); ?>" class="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1">Parent</label>
                                    <select name="parent_id" class="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="">— Top level —</option>
                                        <?php $__currentLoopData = $flattened; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $otherItem = $other->item; ?>
                                            <?php if($otherItem->id === $item->id): ?>
                                                <?php continue; ?>
                                            <?php endif; ?>
                                            <?php if(in_array($otherItem->id, $item->descendantIds(), true)): ?>
                                                <?php continue; ?>
                                            <?php endif; ?>
                                            <option value="<?php echo e($otherItem->id); ?>" <?php echo e((int)$item->parent_id === (int)$otherItem->id ? 'selected' : ''); ?>>
                                                <?php echo e(str_repeat('— ', $other->depth)); ?><?php echo e($otherItem->title); ?>
                                ...
                                <div>
                                    ...
                                    <select name="page_id" class="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="">-- Custom URL --</option>
                                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($page->id); ?>" <?php echo e((int)$item->page_id === (int)$page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1">Custom URL (if no page chosen)</label>
                                    <input type="text" name="url" value="<?php echo e($item->url); ?>" placeholder="https://..." class="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1">Display Order</label>
                                    <input type="number" name="order" value="<?php echo e($item->order); ?>" class="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH C:\Users\marcl\Desktop\my-website\resources\views/admin/menu/index.blade.php ENDPATH**/ ?>